...
public class ComprehensiveTestResults {
    ...
    @Column(name = "test_type", nullable = false, columnDefinition = "NVARCHAR(255)")
    private String test_type;

    @NotNull(message = "Test date cannot be null")
    @Column(name = "test_date", nullable = false, columnDefinition = "DATETIME2")
    ...
    @Column(name = "last_modified", nullable = false, columnDefinition = "DATETIME2")
