...
public interface ComprehensiveGrammarTestAnswerMapper {
    ...
    @Update("UPDATE comprehensive_grammar_test_answer SET is_deleted = 1, last_modified = CURRENT_TIMESTAMP WHERE id = #{id}")
    ...
    @Select("SELECT * FROM comprehensive_grammar_test_answer WHERE id = #{id} AND is_deleted = 0")
    @Results({
    ...
    @Select("SELECT * FROM comprehensive_grammar_test_answer WHERE is_deleted = 0")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "user_answer", column = "user_answer"),
            @Result(property = "options", column = "options"),
    ...
    @Select("SELECT cga.*, g.*, ctr.*, qg.* FROM comprehensive_grammar_test_answer cga " +
            ...
            "WHERE cga.comprehensive_test_results_id = #{testId} AND cga.is_deleted = 0")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "user_answer", column = "user_answer"),
            @Result(property = "options", column = "options"),
