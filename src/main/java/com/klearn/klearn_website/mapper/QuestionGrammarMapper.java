...
public interface QuestionGrammarMapper {
    ...
    @Select("SELECT q.*, g.id as grammar_id, g.grammar_name, g.grammar_description, g.explanation, g.example, g.lesson_number, g.last_modified as grammar_last_modified, g.is_deleted as grammar_is_deleted " +
    ...
    @Results({
            ...
            @Result(property = "grammar.last_modified", column = "grammar_last_modified"),
            @Result(property = "grammar.is_deleted", column = "grammar_is_deleted")
    })
