...
public interface PasswordResetTokenMapper {
    ...
    // Update an existing token with a new token and expiry date
    ...
    // Delete all expired tokens (for SQL Server, GETDATE() can be used)
    @Delete("DELETE FROM password_reset_tokens WHERE expiry_date < GETDATE()")
